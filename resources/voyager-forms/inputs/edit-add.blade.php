                ...
                <div class="row">
                    ...
                    <div class="col-md-4 no-bottom-margin">
                        <div class="form-group">
                            ...
                            <input name="slug" class="form-control" id="slug" value="{{ $input->slug }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 no-bottom-margin">
                        <div class="form-group">
                            <label for="mask">Mascara Primaria</label>
                            <input name="mask" class="form-control" id="mask" value="{{ $input->mask }}">
                        </div>
                    </div>

                        <div class="col-md-4 no-bottom-margin">
                            <div class="form-group">
                                <label for="second_mask">Mascara Secundaria</label>
                                <input name="second_mask" class="form-control" id="second_mask" value="{{ $input->second_mask }}">
                            </div>
                        </div>
