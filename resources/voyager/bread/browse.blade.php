...
@section('content')
    @php
    $color = 0;
    $colors = ['#5cc15a','#c14838','#c03fc1','#d8dc57']
    @endphp
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        @endif
                            ...
                            <div class="well" style="display:flex;justify-content: flex-end">
                                <span style="font-weight: bold;margin-right:15px;">Filtro de colunas:</span>
                                @foreach($dataType->browseRows as $key => $row)

                                    <input style="" type="checkbox" checked class="table-filter" data-table="{{$key}}"><span style="margin-left:5px;margin-right:20px;">{{$row->display_name}}</span>
                                @endforeach
                            </div>
