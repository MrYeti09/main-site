<nav class="navbar navbar-default navbar-fixed-top navbar-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <div style="display:flex;align-items: center;padding:28px 30px 28px 20px;height:30px;width: 30px;float: left;">
                <i class="fas fa-cog config-modal" style="color:#76838f;font-size:18px;"></i>
            </div>
