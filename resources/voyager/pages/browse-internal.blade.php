...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('delete',app($dataType->model_name))
                <a href="{{route(' voyager.page-categories.delete',['page_category' => $breadcrumbs[sizeof($breadcrumbs)-1]['text']])}}" title="{{ __('voyager::generic.delete') }}" class="btn btn-danger delete" data-id="{{ $dataTypeContent->first()->page_category_id }}" id="delete-{{ $dataTypeContent->first()->page_category_id }}">
