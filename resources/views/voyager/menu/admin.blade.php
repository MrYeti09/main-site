...
@foreach ($items as $item)
    ...
    <li class="dd-item" data-id="{{ $item->id }}">
        ...
        <div class="dd-handle">
            ...
            @endif
            @if(strlen($item->img)) <img src="{{Voyager::image("menu-builder/".$item->img)}}" style="width: 24px;margin-right:8px;"> @endif
                @if(isset($item->img_hover) and strlen($item->img_hover)) <img src="{{Voyager::image("menu-builder/".$item->img_hover)}}" style="width: 24px;margin-right:8px;">
                @endif
