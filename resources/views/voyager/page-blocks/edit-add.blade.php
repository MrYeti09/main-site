...
@section('page_header')
    <div class="container-fluid" style="">
        <div style="display:flex;align-items: center;padding:10px 0px;padding-bottom: 0px;">
            ...
            <div>
                <h1 id="page-title" style="font-size: 18px;margin: 0">
                    Editando pagina {{$page->title}}
                </h1>
            </div>
            <div style="margin-left:12px;">

                <a class="page-link" href="{{route('voyager.pages.edit',['id' => $page->id])}}" target="_blank">
        ...
        <div>
            <a class="page-link" href="{{url($page->categories_path().$page->slug)}}" target="_blank">
                <i class="fas fa-external-link-alt" style="margin-right:3px;"></i>
                <span style="font-size:11px;">
                    {{url($page->categories_path().$page->slug)}}
                </span>
            </a>
        </div>
    </div>
...
@section('content')
    ...
    $groups = [];
                ...
                <div class="col-md-12" style="padding:15px;">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-body" style="display:flex;align-items: center;padding:20px;">
                            <form role="form" action="{{ route('voyager.page-blocks.store', $page->id) }}"
                                  class="choose-block"
                                  method="POST"
                    ...
                    {{--                                <div class="panel-actions">--}}
                    {{--                                    <a class="btn btn-success" href="{{route('voyager.page-blocks.main-settings')}}">Ir</a>--}}
                    {{--                                </div> <!-- /.panel-actions -->--}}
                    {{--                            </div> <!-- /.panel-heading -->--}}
                    {{--                        </div>--}}
                    {{--                        @php--}}
                    ...
                    {{--                                    <div class="panel-actions">--}}
                    {{--                                        <a class="btn btn-success" href="{{route('voyager.page-blocks.edit',['pageBlock' => $blogPage->id])}}">Ir</a>--}}
                    {{--                                    </div> <!-- /.panel-actions -->--}}
                    {{--                                </div> <!-- /.panel-heading -->--}}
                    {{--                            </div>--}}
                    {{--                        @endif--}}
        ...
        {{--            @endif--}}
        {{--            @else--}}
        {{--            $("optgroup[label=\"Blocks\"]").append('<option   value="template|{{ $path }}">{{ $template["name"] }}@if(app("VoyagerAuth")->user()->role_id == "3")  {{"{".$path."}"}}@endif</option>')--}}
        {{--            @endif--}}
